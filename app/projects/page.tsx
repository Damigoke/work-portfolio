...
import GetUploadsPage from "../uploads/view/page"; // make sure this import is correct
import { useState } from "react";

interface GetUploadsPageProps {
  setActive?: (value: string) => void;
}

export default function ProjectsPage({ setActive }: GetUploadsPageProps) {
      ...
      <div className="container px-2 md:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center max-w-[1200px] w-full mb-20 mx-auto px-4 pt-10">
          <ProjectCard
            ...
            readMoreUrl="/uploads/view"
            linkLabel="View Shows"
            setActive={() => {
              setActive && setActive("/uploads/view"); // ✅ update active tab
              window.location.href = "/uploads/view"; // ✅ navigate to the page
            }}
          />
